...
![Required Trailhead Work](./img/Required%20Trailhead%20Work.png)
...
- [x] **Valid Salesforce DX project** (5 points)  
  ![Valid Salesforce DX project](./img/Valid%20Salesforce%20DX%20project.png)

- [x] **Successful Account query** (5 points)  
  ![Successful Account query](./img/Successful%20Account%20query.png)
...
- [x] **Application runs locally** (4 points)  
  ![Application runs locally](./img/Application%20runs%20locally.png)

- [x] **Reads provided Account JSON data** (3 points)  
  ![Reads provided Account JSON data](./img/Reads%20provided%20Account%20JSON%20data.png)

- [x] **Uses a reusable Account component** (3 points)  
  ![Uses a reusable Account component](./img/Uses%20a%20reusable%20Account%20component.png)

- [x] **Implements the same search, filter, or sort behavior** (3 points)  
  ![Search React](./img/SearchReact.png)
  ![Sorting React](./img/SortingReact.png)
